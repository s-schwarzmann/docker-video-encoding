...
#compute SSIM 
ff_output=$(ffmpeg -i $TMP/out.m3u8 -i $vid_id  -filter_complex "ssim" -f null - 2>&1 > /dev/null)

ffmpeg -i $TMP/out.m3u8 -i $vid_id -lavfi "ssim=ssim.log;[0:v][1:v]psnr=psnr.log" -f null –
